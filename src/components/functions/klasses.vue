<template>
    <div class="picture">
        ...
        <el-dialog title="编辑班级" :visible.sync="dialogVisible" :before-close="handleClose(dialogVisible)" class="dialogSzie">
            ...
            isAdd(tag) { // 0 添加    1 取消
                ...
                if (tag === 0 && this.dialogUsage == 0) {
                   this.$http.post(
                    ...
                    'http://k12soft.vwico.com:8080/management/klasses',
                    {
                ...
                if (tag === 0 && this.dialogUsage == 1) {
                    this.$http.put(
                     'http://k12soft.vwico.com:8080/management/klasses/' + this.kgId,
                     {
